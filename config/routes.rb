Rails.application.routes.draw do
  ...
  #   get 'products/:id' => 'catalog#view'
    ...
    get 'first_report' => 'report#first_report'
    get 'second_report' => 'report#second_report'
    get 'administration' => 'users#administration'
    get 'user' => 'users#user'
    get 'manage_location' => 'users#manage_location'
    get 'manage_villages' => 'users#manage_villages'
